...
<script>
	$(document).ready(function() {
		tinyMCE.init({
			...
			?>
			theme_advanced_buttons2: "link,unlink,anchor,image,charmap,separator,hr,removeformat,visualaid,separator,table,row_after,delete_row,col_after,delete_col,separator,pasteword",
